...
public class CBudgetDIExpense
{
    ...
    public List<MDCostBudgetInfo.ExpenseChartInfo> GetChartExpenseReport(DateTime _DataDate, string _Type)
    {
        ...
        if (_Type == "ALL" || _Type == "Production")
        {
            ...
            foreach (string prdType in ArryPrd)
            {
                string StrPrd = @"SELECT Fiscal_year,ProductType, PRD_APR
                  ,PRD_MAY,PRD_JUN,PRD_JUL,PRD_AUG,PRD_SEP,PRD_OCT,PRD_NOV,PRD_DEC,PRD_JAN,PRD_FEB,PRD_MAR
                    FROM BC_PRODUCTION
                    WHERE Fiscal_year=@Fiscal_year AND ProductType = @ProductType ";
    ...
    public List<MDCostBudgetInfo.ExpenseChartInfo> GetChartExpenseCostCenterReport(DateTime _DataDate, string _Type)
    {
        ...
        foreach (string StrCostCenter in ArryLoop) {
            ...
            string StrPrd = @"SELECT Fiscal_year, PRD_APR,PRD_MAY,PRD_JUN,PRD_JUL,PRD_AUG,PRD_SEP,PRD_OCT,PRD_NOV,PRD_DEC,PRD_JAN,PRD_FEB,PRD_MAR
                    FROM BC_PRODUCTION
                    WHERE Fiscal_year=@Fiscal_year AND ProductType = @ProductType ";
            SqlCommand cmdPrd = new SqlCommand();
            cmdPrd.CommandText = StrPrd;
    ...
    public string GetTargetTypeData(string _Type)
    {
        ...
        switch (_Type)
        {
            case "ALL": TargetType = "DIRECT_EXPENSE"; break;
            case "Production": TargetType = ".DIRECT_EXPENSE_PD"; break;
            case "PDM1YC": TargetType = "..DIRECT_EXPENSE_PDM1YC"; break;
            case "PDA1YC": TargetType = "..DIRECT_EXPENSE_PDA1YC"; break;
            case "PDM2YC": TargetType = "..DIRECT_EXPENSE_PDM2YC"; break;
            case "PDA2YC": TargetType = "..DIRECT_EXPENSE_PDA2YC"; break;
            case "PDMSCR": TargetType = "..DIRECT_EXPENSE_PDMSCR"; break;
            case "PDASCR": TargetType = "..DIRECT_EXPENSE_PDASCR"; break;
            case "PDMF3": TargetType = "..DIRECT_EXPENSE_PDMF3"; break;
            case "PDAF3": TargetType = "..DIRECT_EXPENSE_PDAF3"; break;
            case "PDMOT": TargetType = "..DIRECT_EXPENSE_PDMOT"; break;
            case "PDAL5": TargetType = "..DIRECT_EXPENSE_PDAL5"; break;
            case "ODM": TargetType = "..DIRECT_EXPENSE_ODM"; break;
            case "MTM": TargetType = "..DIRECT_EXPENSE_MTM"; break;
            case "MTA": TargetType = "..DIRECT_EXPENSE_MTA"; break;
            case "EC": TargetType = ".DIRECT_EXPENSE_EC"; break;
            case "UT": TargetType = "..DIRECT_EXPENSE_UT"; break;
            case "WC": TargetType = "..DIRECT_EXPENSE_WC"; break;
            case "QC": TargetType = ".DIRECT_EXPENSE_QC"; break;
