...
public class CBudgetINExpense
{
    ...
    string[] ArryPrdALL = { "1101", "1102", "1201", "1202", "1301", "1302", "1401", "1402", "1501", "1701", "1702", "4310", "4320", "7720", "4110", "4130", "4910", "4210", "4610", "4620", "4140", "4410", "4420", "4430", "4510", "4520", "4710", "4720", "4830", "4810", "4820", "7220", "8120" };
    string[] ArryPrdProduction = { "1101", "1102", "1201", "1202", "1301", "1302", "1401", "1402", "1501", "1701", "1702", "4310", "4320", "7720" };
    ...
    string[] ArryPrdSRCA = { "1302" };
    string[] ArryPrdSRCM = { "1301" };
    ...
    public List<MDCostBudgetInfo.ExpenseChartInfo> GetChartExpenseReport(DateTime _DataDate, string _Type)
    {
        ...
        if (_Type == "ALL" || _Type == "Production")
        {
            ...
            foreach (string prdType in ArryPrd)
            {
                string StrPrd = @"SELECT Fiscal_year,ProductType, PRD_APR,PRD_MAY,
                        PRD_JUN,PRD_JUL,PRD_AUG,PRD_SEP,PRD_OCT,PRD_NOV,PRD_DEC,
                        PRD_JAN,PRD_FEB,PRD_MAR
                    FROM BC_PRODUCTION
                    WHERE Fiscal_year=@Fiscal_year AND ProductType = @ProductType ";
        ...
        try { mLast2Year.dataSaleExpRatio = CeilingData(((_ResLast2Year / _SaleAmountLast2Year)*100), 1); } catch { mLast2Year.dataSaleExpRatio = 0; }
        try
        {
        ...
        foreach (string _Month in ArryPeriod)
        {
            ...
            if (_Month == "APR")
            {
                ...
                try { mExpense.dataSaleExpRatio = CeilingData(((_AccuResAPR / _SaleAmtAPR)*100), 1); } catch { mExpense.dataSaleExpRatio = 0; }
    ...
    public List<MDCostBudgetInfo.ExpenseChartInfo> GetChartExpenseCostCenterReport(DateTime _DataDate, string _Type)
    {
        List<MDCostBudgetInfo.ExpenseChartInfo> oAryResult = new List<MDCostBudgetInfo.ExpenseChartInfo>();
        ...
        foreach (string StrCostCenter in ArryLoop) {
            ...
            string StrPrd = @"SELECT Fiscal_year, PRD_APR,PRD_MAY,PRD_JUN,
                        PRD_JUL,PRD_AUG,PRD_SEP,PRD_OCT,PRD_NOV,PRD_DEC,
                        PRD_JAN,PRD_FEB,PRD_MAR
                    FROM BC_PRODUCTION
                    WHERE ProductType=@ProductType AND Fiscal_year=@Fiscal_year ";
            SqlCommand cmdPrd = new SqlCommand();
            ...
            _PrdAPR += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "APR");
            _PrdMAY += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "MAY");
            _PrdJUN += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "JUN");
            _PrdJUL += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "JUL");
            _PrdAUG += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "AUG");
            _PrdSEP += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "SEP");
            _PrdOCT += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "OCT");
            _PrdNOV += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "NOV");
            _PrdDEC += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "DEC");
            _PrdJAN += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "JAN");
            _PrdFEB += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "FEB");
            _PrdMAR += AccumulateIntData(dtPrd.Rows[0], (StrCostCenter == "ODM") ? true : false, "PRD", "MAR");
    ...
    public List<MDCostBudgetInfo.ExpenseChartInfo> GetChartOtherCostCenterReport(DateTime _DataDate, string _Type)
    {
        ...
        foreach (string dataPrd in ArryPrd) {
            ...
            string StrPrd = @"SELECT Fiscal_year, PRD_APR,PRD_MAY,PRD_JUN,PRD_JUL,
                        PRD_AUG,PRD_SEP,PRD_OCT,PRD_NOV,PRD_DEC,PRD_JAN,PRD_FEB,PRD_MAR
                    FROM BC_PRODUCTION
                    WHERE ProductType=@ProductType AND Fiscal_year=@Fiscal_year ";
            SqlCommand cmdPrd = new SqlCommand();
            cmdPrd.CommandText = StrPrd;
    ...
    public string GetTargetTypeData(string _Type)
    {
        string TargetType = "";
        switch (_Type) {
            case "ALL": TargetType = "INDIRECT_EXPENSE"; break;
            case "Production": TargetType = ".INDIRECT_EXPENSE_PD"; break;
            case "PDM1YC": TargetType = "..INDIRECT_EXPENSE_PDM1YC"; break;
            case "PDA1YC": TargetType = "..INDIRECT_EXPENSE_PDA1YC"; break;
            case "PDM2YC": TargetType = "..INDIRECT_EXPENSE_PDM2YC"; break;
            case "PDAsYC": TargetType = "..INDIRECT_EXPENSE_PDA2YC"; break;
            case "PDMSCR": TargetType = "..INDIRECT_EXPENSE_PDMSCR"; break;
            case "PDASCR": TargetType = "..INDIRECT_EXPENSE_PDASCR"; break;
            case "PDMF3": TargetType = "..INDIRECT_EXPENSE_PDMF3"; break;
            case "PDAF3": TargetType = "..INDIRECT_EXPENSE_PDAF3"; break;
            case "ODM": TargetType = "..INDIRECT_EXPENSE_ODM"; break;
            case "PDMOT": TargetType = "..INDIRECT_EXPENSE_PDMOT"; break;
            case "PDAL5": TargetType = "..INDIRECT_EXPENSE_PDAL5"; break;
            case "MTM": TargetType = "..INDIRECT_EXPENSE_MTM"; break;
            case "MTA": TargetType = "..INDIRECT_EXPENSE_MTA"; break;
            case "TD": TargetType = "..INDIRECT_EXPENSE_TD"; break;
            case "Procurement": TargetType = ".INDIRECT_EXPENSE_PROCUREMENT"; break;
            case "PU": TargetType = "..INDIRECT_EXPENSE_PU"; break;
            case "SPU": TargetType = "..INDIRECT_EXPENSE_SPU"; break;
            case "SP": TargetType = "..INDIRECT_EXPENSE_SP"; break;
            case "PartSupply": TargetType = ".INDIRECT_EXPENSE_PC"; break;
            case "IM": TargetType = "..INDIRECT_EXPENSE_IM"; break;
            case "PS": TargetType = "..INDIRECT_EXPENSE_PS"; break;
            case "DC": TargetType = "..INDIRECT_EXPENSE_DC"; break;
            case "Engineer": TargetType = ".INDIRECT_EXPENSE_EN"; break;
            case "ENA": TargetType = "..INDIRECT_EXPENSE_ENA"; break;
            case "ENM": TargetType = "..INDIRECT_EXPENSE_ENM"; break;
            case "ENMOT": TargetType = "..INDIRECT_EXPENSE_ENMOT"; break;
            case "EC": TargetType = ".INDIRECT_EXPENSE_EC"; break;
            case "UT": TargetType = "..INDIRECT_EXPENSE_UT"; break;
            case "WC": TargetType = "..INDIRECT_EXPENSE_WC"; break;
            case "Quality": TargetType = ".INDIRECT_EXPENSE_QC"; break;
            case "QA": TargetType = "..INDIRECT_EXPENSE_QA"; break;
            case "QC": TargetType = "..INDIRECT_EXPENSE_QC"; break;
            case "QS": TargetType = "..INDIRECT_EXPENSE_QS"; break;
            case "Design": TargetType = ".INDIRECT_EXPENSE_DD"; break;
            case "DD": TargetType = "..INDIRECT_EXPENSE_DD"; break;
            case "CD": TargetType = "..INDIRECT_EXPENSE_CD"; break;
            case "GA": TargetType = ".INDIRECT_EXPENSE_GA"; break;
