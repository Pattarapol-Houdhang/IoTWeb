...
public class ConnectDBCosty
{
    ...
    public SqlConnection SqlStrCon(string dbName)
    {
        ...
        {
            case "DBSCM" : return new SqlConnection("Data Source=costy3;Initial Catalog=dbSCM;Persist Security Info=True;User ID=sa;Password=decjapan;");                
            ...
            case "DBBCS": return new SqlConnection("Data Source=192.168.226.86;Initial Catalog=dbBCS;Persist Security Info=True;User ID=sa;Password=decjapan;");
            ...
            case "DBIOT": return new SqlConnection("Data Source=costy;Initial Catalog=dbIoT;Persist Security Info=True;User ID=sa;Password=decjapan;");
