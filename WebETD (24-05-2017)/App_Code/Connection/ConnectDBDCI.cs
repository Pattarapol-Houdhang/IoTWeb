...
public class ConnectDBDCI
{
    private bool useDB = true;
    //Private serverName As String = "(Local)\sqlexpress"
    //Private databaseName As String = "SYSQP"
    private string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["dbDCI"].ConnectionString;
    //=================================================================================
    //Constructor
    //=================================================================================
    ...
    public void ExecuteCommand(SqlCommand commandDb)
    {
        if (useDB)
        {
            HttpContext.Current.Session["QueryError"] = "";
            SqlConnection conn = new SqlConnection(connStr);
            try
            {
                commandDb.Connection = conn;
