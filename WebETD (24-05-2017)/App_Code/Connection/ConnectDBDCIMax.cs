...
/// </summary>
public class ConnectDBDCIMax
{
    public ConnectDBDCIMax()
    {
        //
    ...
    {
        return new SqlConnection("Data Source=costy;Initial Catalog=dbDCI;Persist Security Info=True;User ID=sa;Password=decjapan;");
    }
