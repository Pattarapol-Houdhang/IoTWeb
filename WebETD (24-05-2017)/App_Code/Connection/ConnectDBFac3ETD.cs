...
public class ConnectDBFac3ETD
{
    private bool useDB = true;
    //Private serverName As String = "(Local)\sqlexpress"
    //Private databaseName As String = "SYSQP"
    private string connStr = System.Configuration.ConfigurationManager.ConnectionStrings["ETD_FAC3ConnectionString"].ConnectionString;
    //=================================================================================
    //Constructor
    //=================================================================================
