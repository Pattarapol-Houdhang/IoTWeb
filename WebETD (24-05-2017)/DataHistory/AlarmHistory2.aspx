<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageVersion2.master" AutoEventWireup="true" CodeFile="AlarmHistory2.aspx.cs" Inherits="AlarmHistory2_PackingTracking" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="margin-top: 0px !important; font-weight: bold"><i class="fa fa-search"></i>Alarm History</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="row" style="margin-top: 10px">
                                        ...
                                        <label class="col-sm-1 control-label" style="text-align: right!important">Shift</label>
                                        <div class="col-sm-1">
