<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPage.master" AutoEventWireup="true" CodeFile="CRData.aspx.cs" Inherits="DataHistory_CRData" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="page-header">
                ...
                <h1>
                    <i class="icon-bars"></i>
                    CR Data (Label Number)
            <small>
                Search CR Data by <b>Label</b> Number.
            </small>
                </h1>
