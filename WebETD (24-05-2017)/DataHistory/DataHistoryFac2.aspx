<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPage.master" AutoEventWireup="true" CodeFile="DataHistoryFac2.aspx.cs" Inherits="DataHistory_DataHistoryFac2" %>
                    ...
                    <td>
                        <div class="col-sm-2 col-md-2">
                            ...
                            <asp:DropDownList ID="DropDownListPart" runat="server" CssClass="form-control" Style="width: 100%;">
                                <asp:ListItem Text="Pipe Line 3" Value="ACP-0071" />
                                <asp:ListItem Text="Pipe Line 4" Value="ACP-0071" />
                        ...
                        <div class="col-sm-2 col-md-2">
                            ...
                            <asp:LinkButton CssClass="btn btn-success" ID="btnExcel" runat="server" Width="50%" Height="30px" BorderStyle="Double" Enabled="false" OnClick="btnExcel_Click">
