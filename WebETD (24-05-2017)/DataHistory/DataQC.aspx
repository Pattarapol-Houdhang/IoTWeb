<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPage.master" AutoEventWireup="true" CodeFile="DataQC.aspx.cs" Inherits="DataHistory_DataLeakcheck" %>
                ...
                <tr>
                    <div class="col-sm-2 col-md-2">
                        ...
                        <asp:DropDownList ID="DropDownListPart" runat="server" AutoPostBack="True" CssClass="form-control" style="width: 100%;">
                            <asp:ListItem Text="QC Temp Data" Value="1" />
