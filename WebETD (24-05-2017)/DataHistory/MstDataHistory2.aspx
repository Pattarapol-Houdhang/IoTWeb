<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPage.master" AutoEventWireup="true" CodeFile="MstDataHistory2.aspx.cs" Inherits="MstDataHistory2" %>
    ...
    <div>
        ...
        <%--<asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpPanel">
            <ProgressTemplate>
                <div class="modal2">
                    <div class="center">
                        <img alt="" src="images/loading/gears.gif" />
                    </div>
                </div>
            </ProgressTemplate>
        </asp:UpdateProgress>
                    ...
                    <table>
                        <tr>
                            <div class="col-sm-2 col-md-2">
                                <h4>Part</h4>
                                <asp:DropDownList ID="DropDownListPart" runat="server" CssClass="form-control" style="width: 100%;">
                                    <asp:ListItem Text="Crank Shaft Result" Value="1"/>
                                    <asp:ListItem Text="Cylinder Centering" Value="9"/>
                                    <asp:ListItem Text="Cylinder Result" Value="3"/>
                                    <asp:ListItem Text="Front Head Result" Value="4"/>
                                    <asp:ListItem Text="Front Head Riveting" Value="7"/>
                                    <asp:ListItem Text="Matching Result" Value="6"/>
                                    <asp:ListItem Text="Piston Result" Value="2"/>
                                    <asp:ListItem Text="Rear Centering" Value="8"/>
                                    <asp:ListItem Text="Rear Head Result" Value="5"/>                                    
                                    <asp:ListItem Text="Torque Check" Value="10"/>
                                </asp:DropDownList>
                            </div>
                            <%--<div class="col-sm-2 col-md-2">
                                <h4>Type</h4>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceType" runat="server" ConnectionString="<%$ ConnectionStrings:ETDConnectionString %>" SelectCommand="SELECT [pt_id], [pt_name] FROM [vi_part_type] where p_id=@p_id ORDER BY [pt_name]">
                                    <SelectParameters>
                            ...
                            <div class="col-sm-2 col-md-2">
                                <h4>Start Date</h4>
                                <%--<input type="text" id="start" class="datetimepickerStart" runat="server" style="width: 100%;" />--%>
