<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPage.master" AutoEventWireup="true" CodeFile="QuantityData.aspx.cs" Inherits="DataHistory_QuantityData" %>
            ...
            <div class="board-widget">
                                            ...
                                            <div class="form-horizontal form-box">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <asp:DropDownList ID="ddlMachine" runat="server" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <asp:TextBox ID="txtSerialNumber" runat="server" class="form-control col-md-7 col-xs-12"></asp:TextBox>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        Summary Data: <asp:Label ID="lbSummaryData" runat="server" Text=""></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal">
                            ...
                            </div> <!-- table table-bordered table-hover responsive -->
                        </asp:Panel>
                    </div>
                </div>
            </div>
