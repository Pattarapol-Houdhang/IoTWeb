<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="Efficiency_ReportMecha.aspx.cs" Inherits="Efficiency_ReportMecha" %>
...
<body>
    <script type='text/javascript'>
        $(document).ready(function () {
            ...
            var jsonData = [];
            var url = 'Production/SourcJson.ashx?CycleTime=30&Fac=&Line=&Mac=&ModelCode=&strDate=&endDate=&target=';
                        ...
                        events: {
                            load: function () {
                                ...
                                setInterval(function () {
                                    ...
                                    var Line = $("#<%= ddlLine.ClientID %>").val();
                                    url = 'Production/SourcJson.ashx?CycleTime=' + CycleTime + '&Fac=&Line=' + Line + '&Mac=&ModelCode=&strDate=&endDate=&target=';
                                    $.getJSON(url,
                                    function (data2) {
                                        var _EffVal = 0;
    ...
    <div class="main-warpper">
        <form id="form1" runat="server">
            ...
            <asp:Timer ID="Timer1" Interval="30000" OnTick="Timer1_Tick" runat="server"></asp:Timer>
                ...
                <div id="BoxDate">
                    <div class="form-group">
                        <table class="tbTime">
                            <tr>
                                <td>
                                    <asp:Label Font-Bold="true" Font-Size="14px" ID="Label2" runat="server" Text="Search Information in the Past"></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="datepicker" runat="server" CssClass="form-control"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlShipt" runat="server" CssClass="form-control">
                                        <asp:ListItem Value="D" Text="Day"></asp:ListItem>
                                        <asp:ListItem Value="N" Text="Night"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <asp:Button ID="btnSetDate" OnClick="btnSetDate_Click" Text="OK" class="btn btn-primary" runat="server" />
                                </td>
                            </tr>
                        </table>                                                                        
                    </div>
