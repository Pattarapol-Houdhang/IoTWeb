...
public class AllManPower : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else if (pCostCenter == "MPFAC3CP" || pCostCenter == "MPFAC3CS" || pCostCenter == "MPFAC3CY" || pCostCenter == "MPFAC3FH" || pCostCenter == "MPFAC3RH" || pCostCenter == "MPFAC3PI"
             || pCostCenter == "MPFAC3MOT" || pCostCenter == "MPFAC3MA" || pCostCenter == "MPFAC3AS" || pCostCenter == "MPFAC3FIN"
            )
        {
            oListMP = oMP.GetChartMPDailybyAndon(Year, Month, dataDate, pCostCenter);

        }
        //----- Attandace Man Power by Factory Prev Month   -------
        else if (pCostCenter == "MPFAC3CPPrev"
             || pCostCenter == "MPFAC3CSPrev"
              || pCostCenter == "MPFAC3CYPrev"
            || pCostCenter == "MPFAC3FHPrev"
            || pCostCenter == "MPFAC3RHPrev"
            || pCostCenter == "MPFAC3PIPrev"
             || pCostCenter == "MPFAC3MOTPrev"
            || pCostCenter == "MPFAC3MAPrev"
              || pCostCenter == "MPFAC3ASPrev"
             || pCostCenter == "MPFAC3FINPrev")
        {
            oListMP = oMP.GetChartMPDailybyAndon(_LastYearPrev, Prev, dataDate, pCostCenter);

        } //----- Attandace Man Power by Factory Prev Month   -------
        else if (pCostCenter == "MPFAC3CPPrev2" || pCostCenter == "MPFAC3CSPrev2" || pCostCenter == "MPFAC3CYPrev2" || pCostCenter == "MPFAC3FHPrev2"
         || pCostCenter == "MPFAC3RHPrev2" || pCostCenter == "MPFAC3PIPrev2" || pCostCenter == "MPFAC3MOTPrev2" || pCostCenter == "MPFAC3MAPrev2"
             || pCostCenter == "MPFAC3ASPrev2" || pCostCenter == "MPFAC3FINPrev2")
        {
            oListMP = oMP.GetChartMPDailybyAndon(_LastYearPrev2, Prev2, dataDate, pCostCenter);

         } //----- Attandace Man Power by Factory Prev Month   -------
        else if (pCostCenter == "MPFAC3CPPrev3" || pCostCenter == "MPFAC3CSPrev3" || pCostCenter == "MPFAC3CYPrev3" || pCostCenter == "MPFAC3FHPrev3"
         || pCostCenter == "MPFAC3RHPrev3" || pCostCenter == "MPFAC3PIPrev3" || pCostCenter == "MPFAC3MOTPrev3" || pCostCenter == "MPFAC3MAPrev3"
             || pCostCenter == "MPFAC3ASPrev3" || pCostCenter == "MPFAC3FINPrev3")
        {
            oListMP = oMP.GetChartMPDailybyAndon(_LastYearPrev3, Prev3, dataDate, pCostCenter);

        }

        else if (pCostCenter == "MPFAC3OTH")
        {
            oListMP = oMP.GetChartMPDailybyOTHER(Year, Month, dataDate, pCostCenter);

        }
        else if (pCostCenter == "MPFAC3OTHPrev")
        {
            oListMP = oMP.GetChartMPDailybyOTHER(_LastYearPrev, Prev, dataDate, pCostCenter);

        }
        else if (pCostCenter == "MPFAC3OTHPrev2")
        {
            oListMP = oMP.GetChartMPDailybyOTHER(_LastYearPrev2, Prev2, dataDate, pCostCenter);

        }
        else if (pCostCenter == "MPFAC3OTHPrev3")
        {
            oListMP = oMP.GetChartMPDailybyOTHER(_LastYearPrev3, Prev3, dataDate, pCostCenter);

        } 
            
     
        else if (pCostCenter == "MPFAC3MM")
        {
            oListMP = oMP.GetChartMPFAC3Machine(Year, Month, dataDate, pCostCenter);
