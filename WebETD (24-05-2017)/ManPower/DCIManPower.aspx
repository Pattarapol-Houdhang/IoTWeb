...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script src="<%= ResolveClientUrl("~/Highcharts/Modules/drilldown.js") %>"></script>
                                            ...
                                            <div class="nav-tabs-custom">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane " id="tfac3">
                                                        <div class="nav-tabs-custom">
                                                            <ul class="nav nav-tabs">
                                                                <li class="active"><a href="#tF3ALL" data-toggle="tab" id="tabF3ALL">ALL</a></li>
                                                                <li><a href="#tPI" data-toggle="tab" id="tabPI">Piston</a></li>
                                                                <li><a href="#tFH" data-toggle="tab" id="tabFH">Front Head</a></li>
                                                                <li><a href="#tCS" data-toggle="tab" id="tabCS">Crank Shaft</a></li>
                                                                <li><a href="#tCY" data-toggle="tab" id="tabCY">Cylinder</a></li>
                                                                <li><a href="#tRH" data-toggle="tab" id="tabRH">Rear Head</a></li>
                                                                <li><a href="#tMOT" data-toggle="tab" id="tabMOT">Motor</a></li>
                                                                <li><a href="#tCP" data-toggle="tab" id="tabCP">Casing Pipe</a></li>
                                                                <li><a href="#tME" data-toggle="tab" id="tabME">Mecha</a></li>
                                                                <li><a href="#tAS" data-toggle="tab" id="tabAS">Main Assy.</a></li>
                                                                <li><a href="#tFIN" data-toggle="tab" id="tabFIN">Final</a></li>
                                                                <li><a href="#tOTH" data-toggle="tab" id="tabOTH">Other</a></li>

                                                            </ul>
                                                            <div class="tab-content">
                                                                <div class="active tab-pane " id="tF3ALL">
                                                                    <div id="myCarousel3" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3All">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3All" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                ...
                                                                <div class="tab-pane" id="tPI">
                                                                    <div id="myCarousel4" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3PI">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3PI" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3PIPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3PIPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3PIPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3PI" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel4" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel4" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tFH">
                                                                    <div id="myCarousel5" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3FH">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3FH" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FHPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FHPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FHPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FH" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel5" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel5" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tCS">
                                                                    <div id="myCarousel6" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3CS">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3CS" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CSPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CSPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CSPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CS" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel6" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel6" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tCY">
                                                                    <div id="myCarousel7" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3CY">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3CY" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CYPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CYPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CYPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CY" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel7" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel7" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tRH">
                                                                    <div id="myCarousel8" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3RH">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3RH" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3RHPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3RHPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3RHPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3RH" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel8" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel8" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tMOT">
                                                                    <div id="myCarousel9" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3MOT">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3MOT" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MOTPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MOTPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MOTPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MOT" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel9" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel9" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tCP">
                                                                    <div id="myCarousel10" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3CP">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3CP" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CPPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CPPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CPPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3CP" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel10" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel10" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tME">
                                                                    <div id="myCarousel11" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3ME">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3ME" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MAPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MAPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MAPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3MA" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel11" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel11" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tAS">
                                                                    <div id="myCarousel12" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3AS">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3AS" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3ASPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3ASPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3ASPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3AS" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel12" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel12" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tFIN">
                                                                    <div id="myCarousel13" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3FIN">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3FIN" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FINPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FINPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FINPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3FIN" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel13" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel13" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane" id="tOTH">
                                                                    <div id="myCarousel14" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                        <!-- Indicators -->
                                                                        <ol class="carousel-indicators">
                                                                        ...
                                                                        <div class="btnShowHideFac3Machine" data-graphfac3machine="#boxHoldGraphFac3OTH">(-)Machine</div>
                                                                        <div id="boxHoldGraphFac3OTH" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                                            <div class="carousel-inner" style="height: 100% !important">
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3OTHPrev3" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3OTHPrev2" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3OTHPrev" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="item active">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div id="gpMPFAC3OTH" style="min-width: 1300px; height: 400px; margin: 0 auto"></div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <!-- Left and right controls -->
                                                                            <a class="left carousel-control" href="#myCarousel14" data-slide="prev" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-left"></span>
                                                                                <span class="sr-only">Previous</span>
                                                                            </a>
                                                                            <a class="right carousel-control" href="#myCarousel14" data-slide="next" style="width: 5% !important">
                                                                                <span class="glyphicon glyphicon-chevron-right"></span>
                                                                                <span class="sr-only">Next</span>
                                                                            </a>
                                                                        </div>
