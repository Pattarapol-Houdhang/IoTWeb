                    ...
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#tmt" data-toggle="tab" id="tabmt">Maintenance</a></li>
                                <li><a href="#tsupport" data-toggle="tab" id="tabsupport">Support</a></li>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="boxMaintenance" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                  ...
                                                  <div id="gpManMTALL" style="min-width: 1349px; height: 400px; margin: 0 auto"></div>
                                                <div class="col-sm-6">
                                                    <div id="gpManMTM"></div>
                                                </div>
                                                <div class="col-sm-6">
                                ...
                                <div class="tab-pane" id="tsupport">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="btnShowHideAll" data-graphall="#boxSupport">(-)Support</div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="boxHoldGraphFac1" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                  <div id="gpMPFAC1" style="min-width: 1349px; height: 400px; margin: 0 auto"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="boxHoldGraphFac2" class="carousel slide" data-ride="carousel" style="height: 100%">
                                                 <div id="gpMPFAC2" style="min-width: 1349px; height: 400px; margin: 0 auto"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="boxHoldGraphFac3" class="carousel slide" data-ride="carousel" style="height: 100%">
                                               <div id="gpMPFAC3" style="min-width: 1349px; height: 400px; margin: 0 auto"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div id="boxHoldGraphODM" class="carousel slide" data-ride="carousel" style="height: 100%">
                                               <div id="gpMPODM" style="min-width: 1349px; height: 400px; margin: 0 auto"></div>
