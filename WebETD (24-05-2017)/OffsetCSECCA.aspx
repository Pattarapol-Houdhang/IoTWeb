<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageOffsetDetail.master" AutoEventWireup="true" CodeFile="OffsetCSECCA.aspx.cs" Inherits="OffsetCSECC" %>
        ...
        <div class="row">
            <div class="form-horizontal">
                <fieldset title="Crank Shaft Info">
                    <legend>ECCENTRICITY<asp:Label ID="lblStatus" runat="server" Text=""></asp:Label></legend>
                </fieldset>
            </div>
            <div class="row">
                <table>
            ...
            <div class="col-lg-3">
                <div class="cbp-vm-image">
                    <img src="images/ImgPartMaster/2YCCSECC_A.png" width="250" />
                </div>
            </div>
            <div class="col-lg-3">
                <div class="row">
                ...
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">P2</label>
                            <div class="col-lg-7">
                                <asp:TextBox CssClass=" form-control" ID="txtP2" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                            <label class="col-lg-1">µm</label>
                        </div>
                    </div>
