<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageOffsetDetail.master" AutoEventWireup="true" CodeFile="OffsetCSPIN.aspx.cs" Inherits="OffsetCSPIN" %>
        ...
        <div class="row">
            <div class="form-horizontal">
                <fieldset title="Crank Shaft Info">
                    <legend>PIN OD<asp:Label ID="lblStatus" runat="server" Text=""></asp:Label></legend>
                </fieldset>
            </div>
            <div class="row">
                <table>
            ...
            <div class="col-lg-3">
                <div class="cbp-vm-image">
                    <img src="images/ImgPartMaster/2YCCSPIN.png" width="250" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
