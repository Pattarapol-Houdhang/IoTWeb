<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageOffsetDetail.master" AutoEventWireup="true" CodeFile="OffsetCYHEI.aspx.cs" Inherits="OffsetCYHEI" %>
        ...
        <div class="row">
            <div class="form-horizontal">
                <fieldset title="Crank Shaft Info">
                    <legend>HEIGHT<asp:Label ID="lblStatus" runat="server" Text=""></asp:Label></legend>
                </fieldset>
            </div>
            <div class="row">
                <table>
            ...
            <div class="col-lg-3">
                <div class="cbp-vm-image">
                    <img src="images/ImgPartMaster/2YCCYHEI.png" width="250" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">H1</label>
                            <div class="col-lg-3">
                                <asp:TextBox CssClass=" form-control" ID="txtH1" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                ...
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">H2</label>
                            <div class="col-lg-3">
                                <asp:TextBox CssClass=" form-control" ID="txtH2" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                            <label class="col-lg-1">µm</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">H3</label>
                            <div class="col-lg-3">
                                <asp:TextBox CssClass=" form-control" ID="txtH3" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                            <label class="col-lg-1">µm</label>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">H4</label>
                            <div class="col-lg-3">
                                <asp:TextBox CssClass=" form-control" ID="txtH4" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                            <label class="col-lg-1">µm</label>
                        </div>
                    </div>
