<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageOffsetDetail.master" AutoEventWireup="true" CodeFile="OffsetPTBL.aspx.cs" Inherits="OffsetPTBL" %>
        ...
        <div class="row">
            <div class="form-horizontal">
                <fieldset title="Crank Shaft Info">
                    <legend>BLADE<asp:Label ID="lblStatus" runat="server" Text=""></asp:Label></legend>
                </fieldset>
            </div>
            <div class="row">
                <table>
            ...
            <div class="col-lg-3">
                <div class="cbp-vm-image">
                    <img src="images/ImgPartMaster/2YCPTBL.png" width="250" />
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                ...
                <div class="row">
                    <div class="cbp-vm-details">
                        <div class="form-group">
                            <label class="col-lg-1">Perpen.</label>
                            <div class="col-lg-3">
                                <asp:TextBox CssClass=" form-control" ID="txtPerpen" runat="server" MaxLength="6" onkeypress="return isDigitFloat(event, this.value);" required></asp:TextBox>
                            </div>
                            <label class="col-lg-1">µm</label>
                        </div>
                    </div>
