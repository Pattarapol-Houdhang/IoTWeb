...
public partial class Production_FinalLine_ReportNGDataByLabelLine1 : System.Web.UI.Page
{
        ...
        if (txtSerialNo.Text.Trim().Length >= 15) {
            ...
            if (_Line != "0")
            {
                ...
                if (_check == 0)
                {
                    ...
                    string SQLInsert = @"INSERT INTO FG_ReportDefect (dataDate,dataShift,dataLine,
