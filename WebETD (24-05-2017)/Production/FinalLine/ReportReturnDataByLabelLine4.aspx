<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportReturnDataByLabelLine4.aspx.cs" Inherits="Production_FinalLine_ReportReturnDataByLabelLine4" %>
        ...
        <ContentTemplate>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td class="boxContent" align="center" valign="middle">
                        <asp:ImageButton ID="btnTransfer" CssClass="btnTrans" ToolTip="โอนถ่ายข้อมูล" runat="server" BorderWidth="0" ImageUrl="~/images/save-icon.png" OnClick="btnTransfer_Click" OnClientClick="return confirm('กดยืนยันเเพื่อบันทึกข้อมูล NG.')" />
                ...
                <tr>
                    <td class="boxContent" colspan="3" align="left" valign="top">
                        <span class="lblHead">
                            <asp:Label ID="lblTitle" runat="server" Text="List ข้อมูล (LINE 4) :"></asp:Label>
                        </span>
                        <div>
                            <table width="100%" class="tbl">
                                <tr>
                                    <th width="25%" align="center">SerialNo</th>
                                    <th width="25%" align="center">Model</th>
                                    <th width="25%" align="center">Record By</th>
                                    <th width="25%" align="center">Record Date</th>
                                </tr>
