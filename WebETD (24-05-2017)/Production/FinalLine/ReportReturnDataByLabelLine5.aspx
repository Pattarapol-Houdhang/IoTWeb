<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportReturnDataByLabelLine5.aspx.cs" Inherits="Production_FinalLine_ReportReturnDataByLabelLine5" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="boxContent" colspan="3" align="left" valign="top">
                        <span class="lblHead">
                            <asp:Label ID="lblTitle" runat="server" Text="List ข้อมูล (LINE 5) :"></asp:Label>
                        </span>
                        <div>
