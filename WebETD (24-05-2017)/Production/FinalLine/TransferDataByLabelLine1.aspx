<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferDataByLabelLine1.aspx.cs" Inherits="Production_FinalLine_TransferDataByLabelLine1" %>
                ...
                <tr>
                    <td class="boxContent" width="45%" align="center" valign="top">
                        ...
                        <div style="padding-bottom: 15px;">
                            <asp:TextBox ID="txtSerialOld" MaxLength="15" runat="server" class="form-control txtInput" Text="" OnTextChanged="txtSerialOld_TextChanged"  AutoPostBack="true" ></asp:TextBox>
                        </div>
                        <div>
                            <table width="100%" class="tbl">
                                <tr>
                                    <th width="25%" align="center">OIL CHARGE</th>
                                    <th width="25%" align="center">RUNNING TEST</th>
                                    <th width="25%" align="center">HIGH VOLTAGE</th>
                                    <th width="25%" align="center">WEIGHT CHECK</th>
                                    <th width="25%" align="center">APPEARANCE CHECK</th>
                                </tr>
                                <asp:Repeater ID="rptSerialOld" runat="server" OnItemDataBound="rptSerialOld_ItemDataBound"  >
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <asp:Literal ID="ltrLow" runat="server" Text='<%# Eval("HighVoltageData") %>'></asp:Literal>
                                            </td>
                                            <td align="center">
                                                <asp:Literal ID="ltrWeight" runat="server" Text='<%# Eval("WeightCheckData") %>'></asp:Literal>
                                            </td>
                                            <td align="center">
                                                <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("AppCheckData") %>'></asp:Literal>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
                    ...
                    <td class="boxContent" width="45%" align="center" valign="top">
                        ...
                        <div style="padding-bottom: 15px;">
                            <asp:TextBox ID="txtSerialNew" MaxLength="15" runat="server" class="form-control txtInput" Text="" OnTextChanged="txtSerialNew_TextChanged" AutoPostBack="true" ></asp:TextBox>
                        </div>
                        <div>
                            <table width="100%" class="tbl">
                                <tr>
                                ...
                                <asp:Repeater ID="rptSerialNew" runat="server" OnItemDataBound="rptSerialNew_ItemDataBound"  >
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <asp:Literal ID="ltrApp" runat="server" Text='<%# Eval("AppCheckData") %>'></asp:Literal>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                </asp:Repeater>
