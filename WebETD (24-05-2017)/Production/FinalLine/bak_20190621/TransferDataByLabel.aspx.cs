                ...
                if (isCanTransferLabel(txtSerialOld.Text.Trim().Substring(0, 15)))
                {
                    ...
                    if (_DataModelNew == _DataModelOld)
                    {
                        ...
                        if (PipeNew == PipeOld)
                        {
                            ...
                            string strHold = "SELECT prd_serial, remark2 FROM PD_FinalHold WHERE prd_serial=@prd_serial ";
                            ...
                            string strFNCenter = @"SELECT TOP 1 Serial, ModelCode, Line 
                            ...
                            if (dtFNCenter.Rows.Count > 0)
                            {
                                ...
                                strCenter += " [ModelCode],[Line],[LB_InsertDate],[LB_MFGDate],[OC_Judgement], ";
                                ...
                                strCenter += "  SELECT '" + _SerialNew + "', ModelCode, Line, LB_InsertDate, ";
                                ...
                                strCenter += "   WC_InsertDate FROM [dbDCI].[dbo].[FN_DataCenter] ";
