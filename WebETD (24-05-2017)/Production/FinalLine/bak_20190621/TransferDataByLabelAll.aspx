<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferDataByLabelAll.aspx.cs" Inherits="Production_FinalLine_TransferDataByLabelAll" %>
            ...
            <table width="100%">
                ...
                <tr>
                    <td class="boxContent" width="45%" align="center" valign="top">
                        ...
                        <div>
                            <asp:Literal id="TableDataOld" runat="server" ></asp:Literal>
                        </di>
                    </td>
                    ...
                    <td class="boxContent" width="45%" align="center" valign="top">
                        ...
                        <div>
                            <asp:Literal id="TableDataNew" runat="server" ></asp:Literal>
                        </div>
                    </td>
                </tr>
            </table>
