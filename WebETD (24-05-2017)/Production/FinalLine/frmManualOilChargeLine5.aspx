<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmManualOilChargeLine5.aspx.cs" Inherits="Production_FinalLine_frmManualOilChargeLine5" %>
    ...
    <div class="main-container">
        ...
        <ProgressTemplate>
            ...
            <section class="wrapper">
                ...
                <hr />
                <div>
                    <span class="lblHead2">OIL CHARGE : LINE 5</span>
                </div>
                <table width="100%" class="tbl">
                    ...
                    <asp:Repeater ID="rptOilCharge" runat="server" OnItemDataBound="rptOilCharge_ItemDataBound" >
                        <ItemTemplate>
                            <tr>
                                <td align="center">
                                    <asp:Literal ID="ltrSerial" runat="server" Text='<%# Eval("SerialNo") %>'></asp:Literal>
                                </td>
                                <td>
                                    <asp:Literal ID="ltrModel" runat="server" Text='<%# Eval("ModelNo") %>'></asp:Literal>
                                </td>
                                <td align="right">
                                    <asp:Literal ID="ltrBefore" runat="server" Text='<%# Eval("BeforeWeight") %>'></asp:Literal>
                                </td>
                                <td align="right">
                                    <asp:Literal ID="ltrAfter" runat="server" Text='<%# Eval("AfterWeight") %>'></asp:Literal>
                                </td>
                                <td align="center">
                                    <asp:Literal ID="ltrResult" runat="server" Text='<%# Eval("Judgement") %>'></asp:Literal>
                                </td>
                                <td align="center">
