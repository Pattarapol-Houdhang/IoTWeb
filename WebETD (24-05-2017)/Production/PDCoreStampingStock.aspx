<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageVersion2.master" AutoEventWireup="true" CodeFile="PDCoreStampingStock.aspx.cs" Inherits="Quality_PDCoreStampingStock" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="margin-top: 0px !important; font-weight:bold"><i class="fa fa-exclamation-circle"></i>Core Stamping Stock RM</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
