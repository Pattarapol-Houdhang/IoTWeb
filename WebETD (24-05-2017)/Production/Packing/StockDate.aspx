<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageVersion2.master" AutoEventWireup="true" CodeFile="StockDate.aspx.cs" Inherits="Production_Packing_StockDate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function CaldiffDay(picker,txtID) {
            ...
            if (days > 2) {
                $("#"+txtID).val('');
                alert('ไม่สามารถเลือกช่วงเวลาเกิน 2 วันได้ครับ');
            }
        }
        //---------- Calculate StartDay - EndDay for alert in case more than 31 days -----------------------
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="margin-top: 0px !important; font-weight:bold"><i class="fa fa-search"></i>Compressor Stock Warehouse</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
...
<%--                                        <label class="col-sm-1 control-label" style="text-align: right!important">Serial No.</label>
                                        ...
                                        <label class="col-sm-1 control-label" style="text-align: right!important">Stock Date</label>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <asp:Button ID="btnManual" runat="server" Visible="false" class="btn btn-warning btn" Style="margin-left: 15px" Text="Manual" data-link="http://websrv01.dci.daikin.co.jp/iotweb/Production/Packing/ManualPackingTracking.pdf"/>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <asp:Repeater ID="rptPacking" OnItemDataBound="rptPacking_ItemDataBound" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="crDate" runat="server" Text='<%# Eval("prd_date") %>'></asp:Label></td>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label11" runat="server" Text='<%# Eval("prd_line") %>'></asp:Label></td>
                                                       <%-- <td>
