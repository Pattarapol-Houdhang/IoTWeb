<%@ Page Title="" Language="C#" MasterPageFile="~/Template/MasterPageVersion2.master" AutoEventWireup="true" CodeFile="PDUnHoldData.aspx.cs" Inherits="Quality_PDUnHoldData" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header" style="margin-top: 0px !important; font-weight:bold"><i class="fa fa-exclamation-circle"></i>FACTORY 1, 2 - HOLD/UNHOLD</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <asp:DropDownList ID="ddlProdLine" runat="server" CssClass="form-control" >
                                                    <asp:ListItem Value="1YC" >1YC</asp:ListItem>
