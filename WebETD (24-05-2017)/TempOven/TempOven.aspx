<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TempOven.aspx.cs" Inherits="Quality_PDHold" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/js/highcharts.js") %>"></script>
    <script src="<%= ResolveClientUrl("~/js/exporting.js") %>"></script>

    <link href="<%= ResolveUrl("~/StyleMax/js/jquery.dataTables.min.css") %>" rel="stylesheet" />
    <link href="<%= ResolveUrl("~/StyleMax/js/buttons.dataTables.min.css") %>" rel="stylesheet" />


    <script type="text/javascript" src="<%= ResolveClientUrl("~/js/GraphTemp.js") %>"></script>

   <script type="text/javascript" src="~/js/GraphTemp.js"></script>
    ...
    <script type="text/javascript">
        ...
        function LoadData() {
            ...
            $("#btnSearch").click(function (e) {
                var ch = $("#ddlStatus option:selected").text();
                var date = $('#txtDate').val();
                var spDate = date.split('-');
                var startDate = spDate[0].replace(' ', '');
                var endDate = spDate[1].replace(' ', '');

                // LoadData();
                //  LoadJavaScript(startDate, endDate, ch);
                //  alert(endDate);
            });


            $('#txtDate').on('apply.daterangepicker', function (ev3, picker3) {//<----------- Event Date Apply
                ...
                if (parseInt(diffDays) <= 1) {
                    ...
                    alert('เนื่องจากข้อมูลมีจำนวนมาก กรุณาเลือกภายใน 1 วัน ');
                    $(this).val('');
                }
            });

            $('#txtDate').on('cancel.daterangepicker', function (ev3, picker3) {//<----------- Event Date Apply
                $(this).val('');
            });
            //------------------ Prd Date ----------------------
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-lg-12">
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-1 control-label" style="text-align: right!important">Channel</label>
                                                <div class="col-sm-2">
                                                    <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control">
                                                        <asp:ListItem Value="1">CH1</asp:ListItem>
                                                        <asp:ListItem Value="ALL">ALL</asp:ListItem>
                                                        <asp:ListItem Value="2">CH2</asp:ListItem>
                                                        <asp:ListItem Value="3">CH3</asp:ListItem>
                                                        <asp:ListItem Value="4">CH4</asp:ListItem>
                                                        <asp:ListItem Value="5">CH5</asp:ListItem>
                                                        <asp:ListItem Value="6">CH6</asp:ListItem>
                                                        <asp:ListItem Value="7">CH7</asp:ListItem>
                                                        <asp:ListItem Value="8">CH8</asp:ListItem>
                                                        <asp:ListItem Value="9">CH9</asp:ListItem>
                                                        <asp:ListItem Value="10">CH10</asp:ListItem>
                                                        <asp:ListItem Value="11">CH11</asp:ListItem>
                                                        <asp:ListItem Value="12">CH12</asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                        ...
                        <%--   <div class="btnShowHideReal" data-graphreal="#boxHoldGraphReal">(-)Real Trend</div>
                        <div id="boxHoldGraphReal" class="carousel slide" data-ride="carousel" style="height: 100%">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div id="gpReal"></div>
                                </div>
                        ...
                        <div class="btnShowHideChannel" data-graphch="#boxHoldGraphCH">(-)Graph All</div>
                        <div id="boxHoldGraphCH" class="carousel slide" data-ride="carousel" style="height: 100%">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div id="gpCH"></div>
                                </div>
                        ...
                        <div class="btnShowHideChannel" data-graphreal="#boxHoldGraphReal">(-)Graph All</div>
                        <div id="boxHoldGraphReal" class="carousel slide" data-ride="carousel" style="height: 100%">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div id="gpCH1"></div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <asp:Repeater ID="rptPacking" runat="server" OnItemDataBound="rptPacking_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td align="center">
                                                                        <asp:Literal ID="lblDateTime" runat="server" Text='<%# Eval("TimeStamp") %>'></asp:Literal>
                                                                    </td>
                                                                    <td align="center">
                                                                        <asp:Literal ID="lblIDCH" runat="server" Text='<%# Eval("IDCH") %>'></asp:Literal>
                                                                    </td>
                                                                    <td align="center">
                                                                        <asp:Literal ID="lblTemp" runat="server" Text='<%# Eval("Temp") %>'></asp:Literal>
                                                                    </td>
