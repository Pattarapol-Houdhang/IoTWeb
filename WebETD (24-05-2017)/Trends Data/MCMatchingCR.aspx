<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MCMatchingCR.aspx.cs" Inherits="Monitoring_MCMatching" %>
...
<body>
    ...
    <div class="main-container">
        ...
        <table>
            <tr>
                <td><a href="MCMatchingCR.aspx" class="csTopButton selected">CR</a></td>
        ...
        <div id="myCarouselHEI" class="carousel slide main-wrapper content_hei" data-ride="carousel" data-interval="10000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <center><h1>Piston Height</h1></center>
                    <%=resultPTHeight() %>
                </div>
        ...
        <div id="myCarouselHEI" class="carousel slide main-wrapper content_hei" data-ride="carousel" data-interval="10000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <center><h1>Cylinder Height</h1></center>
                    <%=resultCYHeight() %>
                </div>
            </div>
        </div>
