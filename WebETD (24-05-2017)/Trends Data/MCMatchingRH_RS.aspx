<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MCMatchingRH_RS.aspx.cs" Inherits="Monitoring_MCMatchingRH_RS" %>
    ...
    <div class="main-container">
        ...
        <table>
            <tr>
                ...
                <td><a href="MCMatchingFH_FS.aspx" class="csTopButton">FH/ID - FS/OD</a></td>
                <td><a href="MCMatchingRH_RS.aspx" class="csTopButton selected">RH/ID - RS/OD</a></td>
            </tr>
            <tr>
        ...
        <div id="myCarouselHEI" class="carousel slide main-wrapper content_hei" data-ride="carousel" data-interval="10000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <center><h1>Rear Head ID</h1></center>
                    <%=resultRHID() %>
                </div>
        ...
        <div id="myCarouselHEI" class="carousel slide main-wrapper content_hei" data-ride="carousel" data-interval="10000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <center><h1>Rear Shaft OD</h1></center>
                    <%=resultODR() %>
                </div>
            </div>
        </div>
