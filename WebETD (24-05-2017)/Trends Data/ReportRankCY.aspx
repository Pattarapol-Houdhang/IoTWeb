...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="main-container">
        <h4 class="content_bo">ID BORE</h4>
        <div id="myCarousel" class="carousel slide main-wrapper content_bo" data-ride="carousel" data-interval="10000">
        ...
        <h4 class="content_bu">ID BUSH</h4>
        <div id="myCarouselID" class="carousel slide main-wrapper content_bu" data-ride="carousel" data-interval="10000">
            <!-- Wrapper for slides -->
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <%=resultCYBU() %>
