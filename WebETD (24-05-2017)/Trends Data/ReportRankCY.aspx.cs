...
public partial class ReportRankCY : System.Web.UI.Page
{
    ...
    public string CheckBore() {
        string strScript = "<script type='text/javascript' > ";
        strScript += "$(document).ready(function(){";
        if (_boData != null)
        {
            strScript += " $('.content_bo').fadeIn(0); ";
        }
        else {
            strScript += " $('.content_bo').fadeOut(0); ";
        }
        strScript += " });</script>";
        return strScript;
    }
    ...
    public string CheckBush()
    {
        string strScript = "<script type='text/javascript' > ";
        strScript += "$(document).ready(function(){";
        if (_buData != null)
        {
            strScript += " $('.content_bu').fadeIn(0); ";
        }
        else
        {
            strScript += " $('.content_bu').fadeOut(0); ";
        }
        strScript += " });</script>";
        return strScript;
    }
