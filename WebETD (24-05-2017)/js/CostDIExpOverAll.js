function LoadJavaScript() {
    ...
    loadChartSaleData('gpDirectExpense', 'ALL', formatDate(date));

    $("#gpFAC1").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpFAC1', 'FAC1', formatDate(date));

    $("#gpFAC2").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpFAC2', 'FAC2', formatDate(date));

    $("#gpFAC3").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpFAC3', 'FAC3', formatDate(date));
...
function loadChartSaleData(_objChart, _CostCenter, _DataDate) {
    ...
    $.getJSON("BudgetCostChart.ashx?cc=" + _CostCenter + "&Date=" + _DataDate, function (ResponseData) {
