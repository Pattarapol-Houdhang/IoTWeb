function LoadJavaScript() {
    ...
    $("#gpDD").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpDD', 'DD', formatDate(date));

    $("#gpCD").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpCD', 'CD', formatDate(date));
...
function loadChartData(_objChart, _CostCenter, _DataDate) {
    ...
    if (_CostCenter == "Design") {
        dataTitle = "Indirect Expense " + _CostCenter + " Development of " + DataDate.getFullYear();
    } else {
