function LoadJavaScript() {
    ...
    $("#gpENA").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpENA', 'ENA', formatDate(date));

    $("#gpENM").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpENM', 'ENM', formatDate(date));

    $("#gpENMOT").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpENMOT', 'ENMOT', formatDate(date));
