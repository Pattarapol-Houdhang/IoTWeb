function LoadJavaScript() {
    ...
    $("#gpPrdIM").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPrdIM', 'IM', formatDate(date));

    $("#gpPrdPS").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPrdPS', 'PS', formatDate(date));

    $("#gpPrdDC").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPrdDC', 'DC', formatDate(date));
