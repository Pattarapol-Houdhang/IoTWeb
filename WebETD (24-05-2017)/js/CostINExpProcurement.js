function LoadJavaScript() {
    ...
    $("#gpPU").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPU', 'PU', formatDate(date));

    $("#gpSPU").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpSPU', 'SPU', formatDate(date));

    $("#gpSP").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpSP', 'SP', formatDate(date));
