function LoadJavaScript() {
    ...
    $("#gpPDTD").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPDTD', 'PDTD', formatDate(date));
...
function loadChartData(_objChart, _CostCenter, _DataDate) {
    ...
    //$("#boxComment").dialog({ autoOpen: false, resizable: false });

    //$("#btnInsertComment").click(function () {
    //    $.ajax({
    //        async: true,
    //        type: "GET",
    //        url: "BudgetCostComment.ashx",
    //        data: 'pMode=add&pType=' + $("#hidpType").val() + '&pYear=' + $("#hidpYear").val() + '&pMonth=' + $("#hidpMonth").val() + '&pBy=' + $("#hidpBy").val() + '&pComment=' + $("#txtComment").val(),
    //        contentType: "text/plain; charset=utf-8",
    //        dataType: "text",
    //        success: function (response) {
    //            $("#txtComment").val(response);
    //        }
    //    });
    //});

    //$("#btnCloseComment").click(function () {
    //    //$("#boxComment").dialog("close");
    //    $("#hidpType").val('');
    //    $("#hidpYear").val('');
    //    $("#hidpMonth").val('');
    //    $("#hidpBy").val('');
