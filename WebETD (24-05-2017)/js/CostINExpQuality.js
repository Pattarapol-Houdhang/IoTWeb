function LoadJavaScript() {
    ...
    $("#gpQA").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpQA', 'QA', formatDate(date));

    $("#gpQC").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpQC', 'QC', formatDate(date));

    $("#gpQS").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpQS', 'QS', formatDate(date));
...
function loadChartData(_objChart, _CostCenter, _DataDate) {
    ...
    if (_CostCenter == "Quality") {
        dataTitle = "Indirect Expense " + _CostCenter + " Control of " + DataDate.getFullYear();
    } else {
