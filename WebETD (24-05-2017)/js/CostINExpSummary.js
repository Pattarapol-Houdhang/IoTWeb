function LoadJavaScript() {
    ...
    loadChartSaleData('gpIndirectExpense', 'ALL', formatDate(date));

    $("#gpProduction").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpProduction', 'Production', formatDate(date));

    $("#gpProcurement").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpProcurement', 'Procurement', formatDate(date));

    $("#gpPartSupply").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPartSupply', 'PartSupply', formatDate(date));

    $("#gpEngineer").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpEngineer', 'Engineer', formatDate(date));

    $("#gpQuality").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpQuality', 'Quality', formatDate(date));

    $("#gpEC").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpEC', 'EC', formatDate(date));

    $("#gpDesign").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpDesign', 'Design', formatDate(date));

    $("#gpGA").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpGA', 'GA', formatDate(date));
...
function loadChartData(_objChart, _CostCenter, _DataDate) {
    ...
    if (_CostCenter == "ALL") {
        ...
        dataTitle = "Indirect Expense Production Control & SCM of " + DataDate.getFullYear();
    } else {
        dataTitle = "Indirect Expense " + _CostCenter+" of " + DataDate.getFullYear();
    }

    $.getJSON("BudgetINExpense.ashx?cc=" + _CostCenter + "&Date=" + _DataDate, function (ResponseData) {
...
function loadChartSaleData(_objChart, _CostCenter, _DataDate) {
    ...
    if (_CostCenter == "ALL") {
        ...
        dataTitle = "Indirect Expense Factory 1 of " + DataDate.getFullYear();
    } else if (_CostCenter == "FAC2") {
        dataTitle = "Indirect Expense Factory 2 of " + DataDate.getFullYear();
    } else if (_CostCenter == "FAC3") {
        dataTitle = "Indirect Expense Factory 3 of " + DataDate.getFullYear();
    } else if (_CostCenter == "ODM") {
        dataTitle = "Indirect Expense Factory ODM of " + DataDate.getFullYear();
    }
