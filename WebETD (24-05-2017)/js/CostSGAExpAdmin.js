function LoadJavaScript() {
    ...
    $("#gpHR").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpHR', 'HR', formatDate(date));

    $("#gpGA").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpGA', 'GA', formatDate(date));

    $("#gpAC").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpAC', 'AC', formatDate(date));

    //$("#gpCB").html("<img src='../images/loading/gears.gif' border='0' />");
    //loadChartData('gpCB', 'CB', formatDate(date));

    //$("#gpTS").html("<img src='../images/loading/gears.gif' border='0' />");
    //loadChartData('gpTS', 'TS', formatDate(date));

    //$("#gpHRD").html("<img src='../images/loading/gears.gif' border='0' />");
    //loadChartData('gpHRD', 'HRD', formatDate(date));
