function LoadJavaScript() {
    ...
    $("#gpPN").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpPN', 'PN', formatDate(date));

    $("#gpDL").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpDL', 'DL', formatDate(date));

    $("#gpWH").html("<img src='../images/loading/gears.gif' border='0' />");
    loadChartData('gpWH', 'WH', formatDate(date));
